...
class CodeDoctorAgent:
    def __init__(self):
        try:
            ...
            print("🚑 Code Doctor (MEGA PROMPT ACTIVADO) en línea.")
        except:
            print("⚠️ Code Doctor no pudo conectar con Gemini.")

    def heal(self, file_path, error_trace):
        print(f"🔥 ANTIGRAVITY: INTERVINIENDO EN {file_path}")
        ...
        try:
            ...
            print("✅ ¡CÓDIGO REPARADO CON LÓGICA BLINDADA!")
            return True
        except Exception as e:
            print(f"💀 El Doctor falló: {e}")
            return False
